...
export default function NewsletterBox_BeeHiiv({
	...
	disclaimer = 'DISCLAIMER: This is the Newsletter of BoilerplateHQ! Powered by Beehiiv.com. Unsubscribe at anytime by clicking the unsubscribe button in any email sent to you.',
	textForPrivacyPolicy = 'Read our privacy policy',
	linkToPrivacyPolicy = 'https://boilerplatehq.com/privacy-policy',
}: {
	size?: 'sm' | 'lg';
	className?: string;
	title?: string;
