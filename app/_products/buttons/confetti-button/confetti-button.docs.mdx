...
imageAlt: Confetti Button | BoilerplateHQ
hasComponentCode: true
tags: ['Click-Effect']
techStack: ['React', 'Tailwind', 'shadcn/ui']
examples: [{nameOfPage: 'BoilerplateHQ', urlToPage: 'https://boilerplateHQ.com', descriptionOfUsage: 'BoilerplateHQ is using the confetti effect after someone made a purchase!', imgageSrcOfUsage: ''}]
